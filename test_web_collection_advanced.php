...
echo "=== 웹 인터페이스 고급 필터링 수집 테스트 ===".PHP_EOL;
...
try {
    ...
    // Request 객체 생성 (advanced 수집 시뮬레이션)
    $request = new Request();
    $request->merge([
        'type' => 'advanced',
        'filter_start_date' => '2025-08-31',
        'filter_end_date' => '2025-09-01'
    ]);
    
    echo "고급 필터링 수집 테스트 중 (2025-08-31 ~ 2025-09-01)...".PHP_EOL;
    echo "- 패턴 매칭으로 자동 필터링 적용".PHP_EOL;
